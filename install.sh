...
echo -e $USER_NAME $USER_KEY >> /etc/opt/ss5/ss5.passwd
...
echo ""
echo "\033[42;34m 用户名: ${USER_NAME} \033[0m"
echo "\033[42;34m 密码: ${USER_KEY} \033[0m"
echo "\033[42;34m 端口: ${USER_PORT} \033[0m"
echo ""
